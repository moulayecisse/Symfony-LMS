        ...
        var e = function () {
            if (0 != $("#m_chart_personal_income_quater_1").length) {
                var e = new Chartist.Pie("#m_chart_personal_income_quater_1", {
                    ...
                    }, {value: 36, className: "custom", meta: {color: mApp.getColor("brand")}}],
                    labels: [1, 2, 3]
                        ...
                        if (0 != $("#m_chart_personal_income_quater_2").length) {
                            var e = new Chartist.Pie("#m_chart_personal_income_quater_2", {
                                series: [{
                                    ...
                                    value: 44,
                                    className: "custom",
                                    meta: {color: mApp.getColor("success")}
                                }, {
                                    value: 34,
                                    className: "custom",
                        ...
                        if (0 != $("#m_chart_personal_income_quater_3").length) {
                            var e = new Chartist.Pie("#m_chart_personal_income_quater_3", {
                                series: [{
                                    ...
                                    className: "custom",
                                    meta: {color: mApp.getColor("danger")}
                                }, {value: 27, className: "custom", meta: {color: mApp.getColor("brand")}}],
                                labels: [1, 2, 3]
                            }, {donut: !0, donutWidth: 17, showLabel: !1});
                            e.on("draw", function (e) {
                                if ("slice" === e.type) {
    ...
    return {
        init: function () {
            ...
            !function () {
                ...
                data: [{label: "New York", value: 10}, {label: "London", value: 7}, {
                    label: "Paris",
                    value: 20
                }],
                ...
                data: [{label: "Margins", value: 20}, {label: "Profit", value: 70}, {
                    label: "Lost",
                    value: 10
                }],
                labelColor: "#a7a7c2",
